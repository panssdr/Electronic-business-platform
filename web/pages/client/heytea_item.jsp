...
<div id="header">
    ...
    <div>
        ...
        <c:if test="${not empty sessionScope.user}">
            <span>欢迎 <a href="" class="um_span">${sessionScope.user.username}</a>光临尚硅谷书城</span>
...
<div id="main">
    <div class="b_list">
        ...
        <div class="heytea_info">
            ...
            <div class="heytea_amount">
                <span class="sp1">店长推荐:</span>
                <span class="sp2">*****</span>
            </div>
            <div class="heytea_add">
                <button heyTeaId="${heytea.id}" class="addToCart">加入购物车</button>
            </div>
        </div>
    </div>
</div>
