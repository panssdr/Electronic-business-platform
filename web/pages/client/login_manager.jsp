...
<div id="main">
    ...
    <form action="/user/update">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="realname" id="realname" value="${sessionScope.loginuser.realname}" placeholder="Email">
        </div>
        <div class="form-group">
            <label for="age">年龄</label>
            <input type="text" name="age" class="form-control" id="age" value="${sessionScope.loginuser.age}" placeholder="Password">
        </div>
        <div class="form-group">
            <label for="address">家庭住址</label>
            <input type="text" class="form-control" name="address" id="address" value="${sessionScope.loginuser.address}" placeholder="Email">
        </div>
        <div class="form-group">
            <label for="hobby">爱好</label>
            <input type="text" class="form-control" name="hobby"  id="hobby" value="${sessionScope.loginuser.hobby}" placeholder="Password">
        </div>
